...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='Sports', help='Sports | Cloth | Tafeng')
    ...
    parser.add_argument('--num_epochs', default=701, type=int)
    ...
    for epoch in range(epoch_start_idx, args.num_epochs + 1):
        ...
        if epoch == args.num_epochs:
            ...
            fname = 'HTP.epoch={}.lr={}.layer={}.head={}.hidden={}.maxlen={},time={}.pth'
